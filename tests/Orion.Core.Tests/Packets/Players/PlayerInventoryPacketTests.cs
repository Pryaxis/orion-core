...
namespace Orion.Core.Packets.Players
{
    ...
    public class PlayerInventoryPacketTests
    {
        ...
        public void Read()
        {
            var packet = TestUtils.ReadPacket<PlayerInventoryPacket>(_bytes, PacketContext.Server);
        ...
        {
            TestUtils.RoundTripPacket<PlayerInventoryPacket>(_bytes, PacketContext.Server);
        }
    }
}
