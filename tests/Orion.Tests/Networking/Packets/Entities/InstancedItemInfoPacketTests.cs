...
namespace Orion.Networking.Packets.Entities {
    public class InstancedItemInfoPacketTests {
        ...
        private static readonly byte[] InvalidItemPrefixBytes = {
            27, 0, 90, 144, 1, 128, 51, 131, 71, 0, 112, 212, 69, 0, 0, 128, 64, 0, 0, 0, 192, 1, 0, 255, 0, 17, 6
        };

        private static readonly byte[] InvalidItemTypeBytes = {
            27, 0, 90, 144, 1, 128, 51, 131, 71, 0, 112, 212, 69, 0, 0, 128, 64, 0, 0, 0, 192, 1, 0, 82, 0, 255, 127
        };
