...
namespace Orion.Events.Players {
    public class PlayerAnglerQuestsEventArgsTests {
        [Fact]
        public void Ctor_NotDirty() {
            var player = new Mock<IPlayer>().Object;
            var args = new PlayerAnglerQuestsEventArgs(player, new PlayerAnglerQuestsPacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerAnglerQuestsEventArgs> func = () => new PlayerAnglerQuestsEventArgs(player, null);
