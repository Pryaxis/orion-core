...
namespace Orion.Events.Players {
    public class PlayerConnectEventTests {
        [Fact]
        public void Ctor_NotDirty() {
            var player = new Mock<IPlayer>().Object;
            var e = new PlayerConnectEvent(player, new PlayerConnectPacket());
        ...
        public void Ctor_NullPlayer_ThrowsArgumentNullException() {
            Func<PlayerConnectEvent> func = () => new PlayerConnectEvent(null, new PlayerConnectPacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerConnectEvent> func = () => new PlayerConnectEvent(player, null);
        ...
        public void VersionString_SetNullValue_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            var e = new PlayerConnectEvent(player, new PlayerConnectPacket());
            Action action = () => e.VersionString = null;
