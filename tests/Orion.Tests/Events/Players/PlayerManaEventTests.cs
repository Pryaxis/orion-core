...
namespace Orion.Events.Players {
    public class PlayerManaEventTests {
        ...
        public void Ctor_NotDirty() {
            ...
            var args = new PlayerManaEvent(player, new PlayerManaPacket());
        ...
        public void Ctor_NullPlayer_ThrowsArgumentNullException() {
            Func<PlayerManaEvent> func = () => new PlayerManaEvent(null, new PlayerManaPacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerManaEvent> func = () => new PlayerManaEvent(player, null);
