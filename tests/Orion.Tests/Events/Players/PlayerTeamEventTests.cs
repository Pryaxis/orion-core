...
namespace Orion.Events.Players {
    public class PlayerTeamEventTests {
        ...
        public void Ctor_NotDirty() {
            ...
            var args = new PlayerTeamEvent(player, new PlayerTeamPacket());
        ...
        public void Ctor_NullPlayer_ThrowsArgumentNullException() {
            Func<PlayerTeamEvent> func = () => new PlayerTeamEvent(null, new PlayerTeamPacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerTeamEvent> func = () => new PlayerTeamEvent(player, null);
