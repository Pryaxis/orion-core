...
namespace Orion.Events.Players {
    public class PlayerPasswordResponseEventArgsTests {
        [Fact]
        ...
        public void Ctor_NullPlayer_ThrowsArgumentNullException() {
            Func<PlayerPasswordResponseEventArgs> func =
                () => new PlayerPasswordResponseEventArgs(null, new PlayerPasswordResponsePacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerPasswordResponseEventArgs> func = () => new PlayerPasswordResponseEventArgs(player, null);
        ...
        public void PlayerPasswordAttempt_Set_NullValue_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            var args = new PlayerPasswordResponseEventArgs(player, new PlayerPasswordResponsePacket());
            Action action = () => args.PlayerPasswordAttempt = null;
