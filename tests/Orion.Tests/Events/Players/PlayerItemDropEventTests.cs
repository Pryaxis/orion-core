...
namespace Orion.Events.Players {
    public class PlayerItemInfoEventTests {
        [Fact]
        public void Ctor_NotDirty() {
            var player = new Mock<IPlayer>().Object;
            var e = new PlayerItemInfoEvent(player, new ItemInfoPacket());
        ...
        public void Ctor_NullPlayer_ThrowsArgumentNullException() {
            Func<PlayerItemInfoEvent> func = () => new PlayerItemInfoEvent(null, new ItemInfoPacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerItemInfoEvent> func = () => new PlayerItemInfoEvent(player, null);
