...
namespace Orion.Events.Players {
    public class PlayerInventoryEventTests {
        [Fact]
        ...
        public void Ctor_NullPlayer_ThrowsArgumentNullException() {
            Func<PlayerInventoryEvent> func =
                () => new PlayerInventoryEvent(null, new PlayerInventorySlotPacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerInventoryEvent> func = () => new PlayerInventoryEvent(player, null);
