...
namespace Orion.Events.Players {
    public class PlayerPvpEventTests {
        ...
        public void Ctor_NotDirty() {
            ...
            var args = new PlayerPvpEvent(player, new PlayerPvpPacket());
        ...
        public void Ctor_NullPlayer_ThrowsArgumentNullException() {
            Func<PlayerPvpEvent> func = () => new PlayerPvpEvent(null, new PlayerPvpPacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerPvpEvent> func = () => new PlayerPvpEvent(player, null);
