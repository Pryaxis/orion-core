...
namespace Orion.Events.Players {
    public class PlayerHealEffectEventTests {
        [Fact]
        ...
        public void Ctor_NullPlayer_ThrowsArgumentNullException() {
            Func<PlayerHealEffectEvent> func =
                () => new PlayerHealEffectEvent(null, new PlayerHealEffectPacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerHealEffectEvent> func = () => new PlayerHealEffectEvent(player, null);
