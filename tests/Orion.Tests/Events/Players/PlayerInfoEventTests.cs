...
namespace Orion.Events.Players {
    public class PlayerInfoEventTests {
        [Fact]
        public void Ctor_NotDirty() {
            var player = new Mock<IPlayer>().Object;
            var args = new PlayerInfoEvent(player, new PlayerInfoPacket());
        ...
        public void Ctor_NullPlayer_ThrowsArgumentNullException() {
            Func<PlayerInfoEvent> func = () => new PlayerInfoEvent(null, new PlayerInfoPacket());
        ...
        public void Ctor_NullPacket_ThrowsArgumentNullException() {
            var player = new Mock<IPlayer>().Object;
            Func<PlayerInfoEvent> func = () => new PlayerInfoEvent(player, null);
