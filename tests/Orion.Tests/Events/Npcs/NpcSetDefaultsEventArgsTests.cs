...
namespace Orion.Events.Npcs {
    public class NpcSetDefaultsEventArgsTests {
        ...
        public void Ctor_NotDirty() {
            ...
            var args = new NpcSetDefaultsEventArgs(npc, NpcType.None);
        ...
        public void Ctor_NullNpc_ThrowsArgumentNullException() {
            Func<NpcSetDefaultsEventArgs> func = () => new NpcSetDefaultsEventArgs(null, NpcType.None);
        ...
        public void NpcType_Get() {
            var npc = new Mock<INpc>().Object;
            var args = new NpcSetDefaultsEventArgs(npc, NpcType.BlueSlime);
