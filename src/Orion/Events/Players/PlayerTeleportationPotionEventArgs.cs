...
namespace Orion.Events.Players {
    ...
    public sealed class PlayerTeleportationPotionEventArgs : PlayerEventArgs, ICancelable {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerTeleportationPotionEventArgs"/> class with the specified
        /// player.
        /// </summary>
        /// <param name="player">The player.</param>
        /// <exception cref="ArgumentNullException"><paramref name="player"/> is <see langword="null"/>.</exception>
        public PlayerTeleportationPotionEventArgs(IPlayer player) : base(player) { }
    }
}
