...
namespace Orion.Events.Players {
    ...
    public sealed class PlayerDataEventArgs : PlayerPacketEventArgs<PlayerDataPacket> {
        /// <summary>
        ...
        /// </exception>
        public PlayerDataEventArgs(IPlayer player, PlayerDataPacket packet) : base(player, packet) { }
    }
}
