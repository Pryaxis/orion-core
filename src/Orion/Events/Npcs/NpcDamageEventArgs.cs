...
namespace Orion.Events.Npcs {
    ...
    public sealed class NpcDamageEventArgs : NpcEventArgs, ICancelable, IDirtiable {
        private int _damage;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NpcDamageEventArgs"/> class with the specified NPC, damage,
