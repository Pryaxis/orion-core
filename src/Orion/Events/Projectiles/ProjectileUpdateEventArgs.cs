...
namespace Orion.Events.Projectiles {
    ...
    public sealed class ProjectileUpdateEventArgs : ProjectileEventArgs, ICancelable {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectileUpdateEventArgs"/> class with the specified
        /// projectile.
        /// </summary>
        /// <param name="projectile">The projectile.</param>
        /// <exception cref="ArgumentNullException"><paramref name="projectile"/> is <c>null</c>.</exception>
        public ProjectileUpdateEventArgs(IProjectile projectile) : base(projectile) { }
    }
}
