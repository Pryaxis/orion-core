...
namespace Orion.Networking.Packets.Players {
    ...
    public sealed class PlayerDisconnectPacket : Packet {
        private NetworkText _disconnectReason = NetworkText.Empty;

        /// <summary>
        /// Gets or sets the disconnect reason.
        /// </summary>
        /// <exception cref="ArgumentNullException"><paramref name="value"/> is <c>null</c>.</exception>
        public NetworkText DisconnectReason {
            get => _disconnectReason;
            set {
                _disconnectReason = value ?? throw new ArgumentNullException(nameof(value));
                IsPacketDirty = true;
            }
        }
        ...
        public override string ToString() => $"{Type}[{DisconnectReason}]";
