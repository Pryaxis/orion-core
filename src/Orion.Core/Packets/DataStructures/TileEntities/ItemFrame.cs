...
{
    /// <summary>
    /// Represents a serializable item frame.
    /// </summary>
    [StructLayout(LayoutKind.Explicit, Size = 8)]
    public sealed class ItemFrame : SerializableTileEntity
    {
        [FieldOffset(0)] private byte _bytes;  // Used to obtain an interior reference.

        /// <inheritdoc/>
        public override TileEntityId Id => TileEntityId.ItemFrame;

        /// <summary>
        /// Gets or sets the item frame's item.
        /// </summary>
        /// <value>The item frame's item.</value>
