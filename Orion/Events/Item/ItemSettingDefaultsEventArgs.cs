...
namespace Orion.Events.Item
{
	...
	public class ItemSettingDefaultsEventArgs : HandledEventArgs
	{
		...
		/// <summary>
		/// Gets or sets the type that the <see cref="IItem"/> instance is having its defaults set to.
		/// </summary>
		...
		/// <param name="type">The type that the <see cref="IItem"/> instance is having its defaults set to.</param>
