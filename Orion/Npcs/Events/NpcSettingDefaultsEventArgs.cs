...
namespace Orion.Npcs.Events {
    ...
    /// </summary>
    public sealed class NpcSettingDefaultsEventArgs : HandledEventArgs {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NpcSettingDefaultsEventArgs"/> class with the specified NPC
        /// and NPC type.
        /// </summary>
